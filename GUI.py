...
class GUI():
    ...
    def __init__(self):                                         # Initialisation of the different vqriables            
        pygame.init()
        self.difficulty = ""              
        self.screen_width = 0
        ...
        self.font = pygame.font.Font("DS-DIGIT.TTF", 50)        # Font for the timer and bomb count
    ...
    def pos_case(self):                                         # Get the position of the case in the grid          
    ...
    def timer_gui(self, time):                                  # GUI of timer display
        time_str = "{:03d}".format(time // 1000)                
        font = pygame.font.Font("DS-DIGIT.TTF", 50)
        text = font.render(time_str, True, self.RED)
        text_rect = text.get_rect(center=(self.screen_width -45, self.screen_height -30))  
        self.screen.fill((0, 0, 0), text_rect)
        self.screen.blit(text, text_rect)
        pygame.display.update(text_rect)

    def update_bomb_count(self, bomb_count):                    # Bomb count display    
        bomb_count_rect = pygame.Rect(0, self.screen_height - 50, 85, 45)  # Bomb count position        
    ...
    def select_difficulty(self,difficulty_choice):              # Change the size of the grid and the window after the difficulty choice
    ...
    def return_choice(self, difficulty):                        # Return the difficulty choice
        if difficulty == "easy":
            return "easy"
